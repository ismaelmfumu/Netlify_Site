function About() {
  return (
    <div className="bg-blue-50 rounded-xl shadow p-8 my-8">
      ...
      <p className="mt-2 text-gray-700">
        <b>Contact:</b> <a className="text-primary underline" href="https://www.linkedin.com/in/ismael-mfumu-b0b27b1b5" target="_blank" rel="noopener noreferrer">LinkedIn</a>
      </p>
    </div>
  );
}

...
function Projects() {
  ...
  return (
    <section className="bg-white border rounded-xl shadow p-8 my-8" id="projects">
      ...
      {/* Project 1 */}
      <article className="bg-blue-50 rounded-lg p-6 shadow-md mb-6 hover:shadow-lg transition flex flex-col md:flex-row items-center gap-6">
      ...
      <article className="bg-blue-50 rounded-lg p-6 shadow-md mb-6 hover:shadow-lg transition flex flex-col md:flex-row items-center gap-6">
        ...
        <img
          ...
          loading="lazy"
          className={`w-64 h-44 object-cover rounded-lg shadow-lg border-2 border-primary transition-all duration-700 ease-out ${
